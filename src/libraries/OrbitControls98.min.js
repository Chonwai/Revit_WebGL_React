 ...
 * Original file: /npm/three@0.98.0/examples/js/controls/OrbitControls.js
 *
...
(THREE.OrbitControls = function (e, t) {
    ...
    var s = this,
        ...
        l = { type: 'start' },
        m = { type: 'end' },
        u = { NONE: -1, ROTATE: 0, DOLLY: 1, PAN: 2, TOUCH_ROTATE: 3, TOUCH_DOLLY_PAN: 4 },
        d = u.NONE,
        p = 1e-6,
    ...
    function F(e) {
        !1 !== s.enabled &&
            ...
            (function (e) {
                switch (e.keyCode) {
                    case s.keys.UP:
                        D(0, s.keyPanSpeed), s.update();
                        break;
                    case s.keys.BOTTOM:
                        D(0, -s.keyPanSpeed), s.update();
                        break;
                    case s.keys.LEFT:
                        D(s.keyPanSpeed, 0), s.update();
                        break;
                    case s.keys.RIGHT:
                        D(-s.keyPanSpeed, 0), s.update();
                }
...
//# sourceMappingURL=/sm/f33f623f7681f6ca0dcee13465026fbd49a95b7037ac6580e5ef0c5dad98ba96.map
